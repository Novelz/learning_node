...
/*
const weatherstackUrl = "http://api.weatherstack.com/current?access_key=" + weather_apikey +"&query="+place_lat+","+place_lng+"&units="+config.units
...
const mapboxUrl = "https://api.mapbox.com/geocoding/v5/mapbox.places/rome.json?access_token="+map_apikey+"&limit=1"
...
request({url: mapboxUrl, json: true}, (error, response) => {
	...
	console.log("Lat: "+locationInfo.center[1]+", Lng: "+locationInfo.center[0])
})